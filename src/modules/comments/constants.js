...
export const IS_GETTING_USER_COMMENTS = "IS_GETTING_USER_COMMENTS";
export const SET_USER_COMMENTS_ERROR = "SET_USER_COMMENTS_ERROR";
export const CLEAR_USER_COMMENTS_ERROR = "CLEAR_USER_COMMENTS_ERROR";
export const ADD_USER_COMMENTS = "ADD_USER_COMMENTS";
export const CLEAR_USER_COMMENTS = "CLEAR_USER_COMMENTS";
export const SET_USER_COMMENTS_PAGINATION = "SET_USER_COMMENTS_PAGINATION";
